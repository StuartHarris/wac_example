...
macro_rules! __export_world_name_cabi{
...
#[doc(hidden)]
pub(crate) use __export_world_name_cabi;
#[repr(align(4))]
...
macro_rules! __export_name_impl {
  ...
  $($path_to_types_root)*::__export_world_name_cabi!($ty with_types_in $($path_to_types_root)*);
  )
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.25.0:name:encoded world"]
#[doc(hidden)]
...
al-cwd\x01\x06\x03\x01\x1awasi:cli/environment@0.2.0\x05\0\x01@\0\0s\x04\0\x04na\
me\x01\x01\x04\x01\x11example:name/name\x04\0\x0b\x0a\x01\0\x04name\x03\0\0\0G\x09\
